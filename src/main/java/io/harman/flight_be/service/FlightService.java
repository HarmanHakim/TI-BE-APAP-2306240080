...
public interface FlightService {
    ...
    List<ReadFlightDto> searchFlights(String origin, String destination, LocalDateTime departureDate, String airlineId,
            Integer status);
    ...
    boolean isAirplaneAvailable(String airplaneId, LocalDateTime departureTime, LocalDateTime arrivalTime,
            String excludeFlightId);

    // Flight reminders
    List<io.harman.flight_be.dto.flight.FlightReminderDto> getFlightReminders(Integer intervalHours, String customerId);
}
